...
<html>
    ...
    <body>
        <center>
            ...
            <br>
        <h1>List Inventaris Alat Tulis Kantor</h1>
        <?php
            include "database.php";
            $query = "SELECT * FROM inventaris WHERE kategori = 'Alat Tulis Kantor'";
        ...
        ?>
            ...
            <h1><center>Total Inventaris Alat Tulis Kantor Rp.<?= $semua ?></center></h1>
